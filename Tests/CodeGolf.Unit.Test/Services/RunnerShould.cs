    ...
    public class RunnerShould
    {
        ...
        public string Main(string s){ 
            ...
            this.runner.Compile(code, new[] { typeof(string) }, typeof(string), CancellationToken.None).ExtractSuccess()
                ...
                .BeEquivalentTo("Runtime Error line 14 - Index was outside the bounds of the array.");
        }
        ...
        public string Main(string s){ 
            ...
            this.runner.Compile(code, new[] { typeof(string) }, typeof(string), CancellationToken.None).ExtractSuccess()
                .Func(new[] { new object[] { "Hello world" } }).Result.First().ExtractErrors().Should()
                .BeEquivalentTo("Runtime Error line 20 - A task was canceled.");
        }
        ...
        public string Main(string s){
            ...
            this.runner.Compile(code, new[] { typeof(string) }, typeof(string), CancellationToken.None).ExtractSuccess()
                .Func(new[] { new object[] { "Hello world" } }).Result.First().ExtractErrors().Should()
                .BeEquivalentTo("Runtime Error line 21 - A task was canceled.");
        }
