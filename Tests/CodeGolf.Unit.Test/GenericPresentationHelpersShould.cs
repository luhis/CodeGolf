...
namespace CodeGolf.Unit.Test
{
    public class GenericPresentationHelpersShould
    {
        ...
        {
            var r = GenericPresentationHelpers.DisplayFunction(new Challenge<int[]>(new object[] { 1, "a" }, new[] {1, 2, 3}), new[] { typeof(int), typeof(string) }, typeof(int[]));
        ...
        {
            var r = GenericPresentationHelpers.DisplayFunction(new Challenge<string[]>(new object[] { 1, "a" }, new[] { "a", "b" }), new[] { typeof(int), typeof(string) }, typeof(string[]));
