...
namespace CodeGolf.Unit.Test
{
    public class RunnerShould
    {
        ...
        {
            var r = this.runner.Compile<string>("public string Main(string s){ return s;}")(new[] {"Hello world"});
        ...
        {
            var r = this.runner.Compile<string>("public string Main(string s){ return \"not \" + s;}")(new[]
                {"Hello world"});
        ...
        {
            Action a = () => this.runner.Compile<string>("abc")(new[] {"Hello world"});
            a.Should().Throw<Exception>()
                .WithMessage(
                    "(1,39): error CS1519: Invalid token '}' in class, struct, or interface member declaration");
        }

        [Fact]
        public void FailCleanlyWhenFunctionMisnamed()
        {
            var r = this.runner.Compile<string>("public string MainXXX(string s){ return \"not \" + s;}")(new[]
                {"Hello world"});
        ...
        {
            var r = this.runner.Compile<string>("public string Main(string s){ return \"not \" + s;}")(new object[]
                {"Hello world", 1});
        ...
        {
            var r = this.runner.Compile<string>("public int Main(string s){ return 42;}")(new object[] {"Hello world"});
        ...
        {
            var r = this.runner.Compile<string>("public string Main(int i){ return \"not \";}")(new object[]
                {"Hello world"});
...
public string Main(string s){ return s + X();}";
            var r = this.runner.Compile<string>(code)(new[] {"Hello world"});
